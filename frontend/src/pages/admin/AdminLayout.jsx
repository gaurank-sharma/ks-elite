...
const ALL_NAV = [
  { to: "/admin/leads", label: "Leads", icon: Inbox, anyOf: ["leads_contact", "leads_internship"] },
  { to: "/admin/posts", label: "Blog Posts", icon: Newspaper, section: "posts" },
  { to: "/admin/team", label: "Team", icon: Users, section: "team" },
  { to: "/admin/testimonials", label: "Testimonials", icon: MessageSquareQuote, section: "testimonials" },
  { to: "/admin/subscribers", label: "Subscribers", icon: Mail, section: "subscribers" },
  { to: "/admin/analytics", label: "Analytics", icon: BarChart3, section: "analytics" },
  { to: "/admin/users", label: "User Master", icon: ShieldCheck, superOnly: true },
];
