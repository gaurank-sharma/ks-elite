              ...
              {posts.map((p) => (
                <tr key={p.id} className="border-b last:border-0" style={{ borderColor: "var(--line)" }}>
                  ...
                  <td className="px-4 py-3">
                    <span
                      className="rounded-full px-2.5 py-1 text-xs font-mono uppercase tracking-wide"
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-3">
                      <Link to={`/admin/posts/${p.id}/edit`} className="text-[var(--fg-muted)] hover:text-[var(--accent)]" aria-label="Edit">
                        <Pencil size={15} />
                      </Link>
